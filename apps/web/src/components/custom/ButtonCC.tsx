...
type ButtonCCProps = ButtonProps & { //extends ButtonProps to include all props of Chakra UI.
    fontColor: string;
...
const ButtonCC = ({ fontColor, backgroundColor, text, capitalizeText, ...props }: ButtonCCProps) => {
    return (
        <Button
            color={fontColor}
